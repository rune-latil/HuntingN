...
const infoList = [
  {
    ...
    desc: '제로니사는 재빠른 상황판단과 뛰어난 추리력으로<br> 세타케아를 무사히 구출하는데 성공했다.'
  },
  {
    name: 'Ending.02 Bad-후유증',
    desc: '세타케아를 구출하는데에는 성공했지만<br> 시간이 너무 지체된 탓인지 세타케아는 사흘을 앓아누웠고,<br> 납치범 무리의 정체를 파악하지 못한채 사건이 흐지부지 마무리되었다..'
  },
  {
    name: 'Ending.03 Hidden-정리',
    desc: '제로니사는 세타케아를 구출하는 것은 물론 납치범들의 정체가<br> 반역 무리들이라는 것 까지 알아냈다.<br>반역은 둘째치고 부인을 납치한 이들에게 용서는 없다.'
  }
]
